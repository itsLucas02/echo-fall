...
export const LEVELS: readonly LevelBlueprint[] = [
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    parMs: 180_000,
    worldWidth: 7800,
    palette: { sky: 0x7ca99c, tint: 0xffffff, platform: 0x344b44, stroke: 0x688078, moss: 0x77956c, abyss: 0x10201e },
    floorSegments: [
    ...
    hints: [
      ...
      { atX: 4200, text: 'Slam pillars and shutters ahead: leave an echo on the plate and read the rhythm.' },
      { atX: 6950, text: 'A spiked pendulum sweeps the floor. The high road is safer.' },
    ],
    goalX: 7650,
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    parMs: 200_000,
    worldWidth: 7200,
    palette: { sky: 0x2c3f4a, tint: 0x9db4c8, platform: 0x2f4148, stroke: 0x6f8a96, moss: 0x5f7d86, abyss: 0x050c10 },
    floorSegments: [
    ...
    hints: [
      { atX: 2340, text: 'Echo resonators answer only to echoes — record a path through the crystal.' },
      { atX: 4480, text: 'Charge every tea-plate before their glow fades. Three at once opens the gate.' },
      { atX: 5680, text: 'Two crystals, one recording. Plan the route, then release.' },
    ],
    goalX: 7050,
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    parMs: 220_000,
    worldWidth: 7400,
    palette: { sky: 0x9fc3a8, tint: 0xdcead0, platform: 0x3d5a44, stroke: 0x7fae7f, moss: 0x86b06c, abyss: 0x0d1810 },
    floorSegments: [
    ...
    hints: [
      { atX: 2330, text: 'Tea-press plates: follow the lamp order 1 · 2 · 3. A wrong step resets them.' },
      { atX: 4060, text: 'Press the plate to power the terrace lift — or leave an echo on it.' },
      { atX: 5980, text: 'Headwinds ahead. Press the shutter plate and sprint.' },
    ],
    goalX: 7200,
    gateXs: [3120, 6400],
  },
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    parMs: 260_000,
    worldWidth: 8000,
    palette: { sky: 0x8a7a9c, tint: 0xd8c8ec, platform: 0x46405c, stroke: 0x9a8cc0, moss: 0x8a7ab0, abyss: 0x0c0916 },
    floorSegments: [
    ...
    hints: [
      { atX: 1300, text: 'Echo resonators pulse only for echoes.' },
      { atX: 3400, text: 'The warden hunts the closest automaton — feed it your echo.' },
      { atX: 5150, text: 'Both plates at once, like the old vault. The echo remembers how.' },
      { atX: 6600, text: 'Timed shutters: press, then sprint the gauntlet.' },
    ],
    goalX: 7850,
