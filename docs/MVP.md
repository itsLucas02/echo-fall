# Echofall: Clockwork Run - MVP

## Goal

Ship one complete browser-playable platforming level with responsive movement and a distinct Time Echo mechanic.

## Player Experience

The player controls a courier automaton carrying a damaged time core through an overgrown clockwork city. They run, jump, avoid hazards, stomp crawler enemies, collect memory shards, activate a checkpoint, and use a recorded echo to hold pressure plates while passing gates.

## Included

- One 6-9 minute side-scrolling level across four echo chambers
...
- Additional levels, bosses, power-ups, multiple echoes
- Mobile controls, gamepad support, saves, accounts, leaderboards
- Level editor and procedural generation
